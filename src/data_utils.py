...
# Note: none of <s>, </s>, [PAD], [UNK], [START], [STOP] should appear in the 
# vocab file.
...
class Vocab(object):
  ...
  def __init__(self, vocab_file, max_size):
    """Creates a vocab of up to max_size words, reading from the vocab_file. If
    max_size is 0, reads the entire vocab file.
    ...
    print("Finished constructing vocabulary of %i total words. Last word added:'
        ' %s" % (self._count, self._id_to_word[self._count-1]))
  ...
  def MakeWordEmbedding(self):
    ...
    # replace unknown words with UNKNOWN_TOKEN embedding (zero vector)
